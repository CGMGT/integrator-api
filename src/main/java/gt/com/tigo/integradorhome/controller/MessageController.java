...
import gt.com.tigo.integradorhome.service.MessageService;
...
public class MessageController extends AbstractController<MensajesEntity, MessageService> {
    ...
    @Override
    public ResponseEntity<TigoResponseDto> create(MensajesEntity entity, Long requesterId) {
        return null;
    }

    @Override
    public ResponseEntity<TigoResponseDto> update(MensajesEntity entity, Long requesterId) {
        return null;
    }
